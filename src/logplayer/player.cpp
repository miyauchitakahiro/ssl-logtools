    ...
    m_legacyVision(NULL)
{
    ...
    m_referee = new Network(QHostAddress("127.0.0.1"), 0, 10003);//224.5.23.1
    m_referee->connect();

    // create vision socket
    Q_ASSERT(m_vision == NULL);
    m_vision = new Network(QHostAddress("127.0.0.1"), 0, 10006);//224.5.23.1
    m_vision->connect();

    // create legacy vision socket
    Q_ASSERT(m_legacyVision == NULL);
    m_legacyVision = new Network(QHostAddress("127.0.0.1"), 0, 10005);//224.5.23.1
